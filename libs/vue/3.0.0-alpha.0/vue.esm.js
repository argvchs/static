...
export { BaseTransition, Comment, Fragment, KeepAlive, PatchFlags, Portal, PublicShapeFlags as ShapeFlags, Suspense, Text, Transition, TransitionGroup, callWithAsyncErrorHandling, callWithErrorHandling, camelize$1 as camelize, capitalize$1 as capitalize, cloneVNode, compileToFunction as compile, computed$1 as computed, createApp, createBlock, createCommentVNode, createComponent, createHook, createRenderer, createSlots, createTextVNode, createVNode, effect, getCurrentInstance, h, handleError, inject, injectHook, instanceWatch, isReactive, isReadonly, isRef, markNonReactive, markReadonly, mergeProps, nextTick, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onUnmounted, onUpdated, openBlock, popScopeId, provide, pushScopeId, reactive, readonly, recordEffect, ref, registerRuntimeCompiler, render, renderList, renderSlot, resolveComponent, resolveDirective, resolveDynamicComponent, resolveTransitionHooks, setBlockTracking, setTransitionHooks, toHandlers, toRaw, toRefs, toString, useCSSModule, useTransitionState, vModelCheckbox, vModelDynamic, vModelRadio, vModelSelect, vModelText, vShow, version, warn, watch, withDirectives, withKeys, withModifiers, withScopeId };
