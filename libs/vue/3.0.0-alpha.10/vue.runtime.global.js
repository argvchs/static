var Vue = (function (exports) {
  ...
  function normalizeChildren(vnode, children) {
      ...
      if (children == null) {
          ...
          if (vnode.shapeFlag & 1 /* ELEMENT */ && children.default) {
  ...
  function resolveProps(instance, rawProps, _options) {
      ...
      if (propsProxy && (patchFlag === 0 || patchFlag & 16 /* FULL_PROPS */)) {
  ...
  */
  ...
  function createHydrationFunctions(rendererInternals) {
      ...
      const hydratePortal = (vnode, parentComponent, parentSuspense, optimized) => {
          ...
          const target = (vnode.target = isString(targetSelector)
              ...
              : targetSelector);
          if (target && vnode.shapeFlag & 16 /* ARRAY_CHILDREN */) {
  ...
  function createAsyncComponent(source) {
      if (isFunction(source)) {
          source = { loader: source };
      }
      const { suspensible = true, loader, loading: loadingComponent, error: errorComponent, delay = 200, timeout // undefined = never times out
       } = source;
      let pendingRequest = null;
      let resolvedComp;
      const load = () => {
          return (pendingRequest ||
              (pendingRequest = loader().then((comp) => {
      ...
      return defineComponent({
          ...
          setup() {
              ...
              if (( suspensible && currentSuspense) ||
                  (false )) {
                  return load()
                      .then(comp => {
  ...
  function createInnerComp(comp, { props, slots }) {
      return createVNode(comp, props === EMPTY_OBJ ? null : props, slots === EMPTY_OBJ ? null : slots);
  }
  ...
  function resolveDynamicComponent(component) {
      ...
      if (isString(component)) {
          return (resolveAsset(COMPONENTS, component, currentRenderingInstance, false) ||
  ...
  function resolveAsset(type, name, instance = currentRenderingInstance ||
      currentInstance, warnMissing = true) {
      if (instance) {
